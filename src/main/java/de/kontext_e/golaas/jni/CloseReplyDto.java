...
public class CloseReplyDto implements ReplyDto {
  private byte returnCode;

  public CloseReplyDto(byte returnCode) {
  ...
  public boolean equals(Object object) {
    ...
    CloseReplyDto other = (CloseReplyDto) object;
